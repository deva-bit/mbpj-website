    ...
    <div>
        ...
        <Card title="Pengguna"
          extra={<div className="button-container">
            <Button type="primary" onClick={() => setIsModalOpen(true)}><UserAddOutlined rev={undefined} /> Tambah Pengguna</Button>
            <Button style={{ margin: "5px" }} type="primary" onClick={() => setIsModalOpen(true)}><SisternodeOutlined   rev={undefined} /> Tambah Role</Button>
