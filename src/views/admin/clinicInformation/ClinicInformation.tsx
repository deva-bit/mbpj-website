...
import AddModalClinicInformation from './AddModalClinicInformation';
import EditModalClinicInformation from './EditModalClinicInformation';
...
const ClinicInformation = () => {
  ...
  return (
    <div>
      <Spin spinning={isLoadingClinicInformation} tip="Loading...">
        <Card title="Clinic Informartion"
          extra={<div className="button-container">
            <Button type="primary" onClick={() => setIsModalOpen(true)}><PlusOutlined rev={undefined} /> Add Clinic Information</Button>{isModalOpen && <AddModalClinicInformation successfullAdd={successfullAdd} closeModal={() => setIsModalOpen(false)} />}</div>} className="my-card">
        ...
        {isEditModalOpen && (
          <EditModalClinicInformation successfullEdit={successfullEdit} editData={isEditData} closeModal={() => setIsEditModalOpen(false)} />
        )}
      </Spin>
    </div>
  );
